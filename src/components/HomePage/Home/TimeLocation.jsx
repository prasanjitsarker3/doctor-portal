...
const TimeLocation = () => {
    return (
        <div className="grid md:grid-cols-3 gap-5 py-7 px-5">
            <div className='bg flex justify-between items-center p-5 rounded'>
                <img src={open} alt="" />
            ...
            <div className=' bg-black flex justify-between items-center p-5 rounded'>
            ...
            <div className=' bg-blue flex justify-between items-center p-5 rounded'>
                <img src={call} alt="" />
                <div className='px-4 text-white'>
