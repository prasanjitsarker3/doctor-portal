            ...
            <div className="hero py-10">
                <div className="grid md:grid-cols-2 gap-5">
                    <div data-aos="fade-right"
                        data-aos-offset="300"
                        data-aos-easing="ease-in-sine" className='flex justify-center items-center md:w-full w-1/2 mx-auto'>
                    ...
                    <div data-aos="fade-left"
                        data-aos-offset="300"
                        data-aos-easing="ease-in-sine" className='flex justify-center items-center mx-auto'>
                        <div className='px-5'>
